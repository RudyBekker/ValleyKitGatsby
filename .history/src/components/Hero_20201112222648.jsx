...
export const Hero = props => {
  ...
  return (
    <div className="container mt-12">
      <div className="flex relative rounded-md overflow-hidden bg-yellow-600">
        <Img
          alt={title}
        ...
        <span className="absolute top-0 right-0 bg-yellow-700 text-sm text-white font-medium px-3 py-1 rounded-lg m-4 tracking-wide">
          {tag}
        </span>
